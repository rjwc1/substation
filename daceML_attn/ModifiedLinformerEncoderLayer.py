...
class LinformerEncoderLayer(nn.Module):
    def __init__(self, dim, seq_len, k = 256, heads = 8, dropout = 0.):
        ...
        self.attn_layer = PreNorm(dim, attn)
        self.ff_layer = PreNorm(dim, ff)
...
if __name__ == '__main__':
    ...
    linformer_layer.append_post_onnx_hook("fuse_tasklets", lambda x:\
    ...
    linformer_layer.append_post_autodiff_hook("vectorize", vectorize)
