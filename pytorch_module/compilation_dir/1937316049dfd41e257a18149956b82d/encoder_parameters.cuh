...
#define ENCODER_SOFTMAX_DROPOUT_PROBABILITY 0.1

#define ENCODER_RESIDUAL1_DROPOUT_PROBABILITY 0.1

#define ENCODER_ACTIVATION_DROPOUT_PROBABILITY 0.1

#define ENCODER_RESIDUAL2_DROPOUT_PROBABILITY 0.1
